function StudentCtrl($scope) {
  ...
  $scope.students = [
    ...
    { "first":'Domen', "last":'Vajevec', "linkedin":'in/domenvajevec/', "github":'domenvajevec', "twitter":'domenvajevec', "portfolio":'', "angellist":'', "imgURL":'images/domen.jpg', "bio":'' },
